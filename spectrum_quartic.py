...
ax1 = plt.subplot()
ax2 = ax1.twinx()
line1 = ax1.plot(K_values*conver,Ds*1e9,color='b',linewidth=3,label=r'$\Delta_{s}^{2}$ (numérico)')
line2 = ax1.plot(K_values*conver,Ds_appr*1e9,color='b',linewidth=3,linestyle='--',label=r'$\Delta_{s}^{2}$ (de Sitter)')
line3 = ax1.plot(K_values*conver,Dt*1e9,color='r',linewidth=3,label=r'$\Delta_{t}^{2}$ (numérico)')
line4 = ax1.plot(K_values*conver,Dt_appr*1e9,color='r',linewidth=3,linestyle='--',label=r'$\Delta_{t}^{2}$ (de Sitter)')
